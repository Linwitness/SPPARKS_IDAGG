...
if __name__ == '__main__':
    path  = "/Users/lin.yang/projects/SPPARKS-AGG/examples/Test_SimplifyIncE/2d_poly/"
    file_name = "spparks"
    figure_path="video/p_random_enrgy_2low"

    timestep, npy_matrix = dump2npy(path+file_name, 101)
    print(npy_matrix.shape)
    np.save('poly_xy43_inc0.2_xy', npy_matrix)
